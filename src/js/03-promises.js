...
function handleFormSubmit() {
  ...
  const stepValue = selectors.stepInput.valueAsNumber;
  const amountValue = selectors.amountInput.valueAsNumber;
  ...
  // selectors.delayInput.value = '';
  // selectors.stepInput.value = '';
